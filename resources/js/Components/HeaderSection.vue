<template>
  <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
    <div class="text-center">
      ...
      <div
        class="mt-3 max-w-md mx-auto md:mt-10 md:max-w-3xl inline-flex items-center text-white bg-white rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base"
      >
        <span
